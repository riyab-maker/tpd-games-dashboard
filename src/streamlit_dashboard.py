...
def render_modern_dashboard(
    ...
    game_mapped_users = {
        'Shape Circle': {'started': 22302, 'introduction': 21810, 'mid_introduction': 19168, 'parent_poll': 15529, 'validation': 19003, 'rewards': 18473, 'completed': 19950, 'questions': 20311},
        'Shape Triangle': {'started': 10807, 'introduction': 10609, 'mid_introduction': 8930, 'parent_poll': 6480, 'validation': 8830, 'rewards': 8526, 'completed': 9300, 'questions': 9632},
        'Color Red': {'started': 16207, 'introduction': 15835, 'mid_introduction': 13647, 'parent_poll': 10232, 'validation': 13444, 'rewards': 12805, 'completed': 13971, 'questions': 14544},
        'Color Yellow': {'started': 8292, 'introduction': 8068, 'mid_introduction': 6509, 'parent_poll': 4715, 'validation': 6435, 'rewards': 6267, 'completed': 7127, 'questions': 7035},
        'Numbers I': {'started': 9701, 'introduction': 9534, 'mid_introduction': 8211, 'parent_poll': 5920, 'validation': 8091, 'rewards': 7798, 'completed': 8363, 'questions': 8715},
        'Numbers II': {'started': 6947, 'introduction': 6847, 'mid_introduction': 5916, 'parent_poll': 4214, 'validation': 5842, 'rewards': 5669, 'completed': 6035, 'questions': 6268},
        'Relational Comparison': {'started': 5176, 'introduction': 5090, 'mid_introduction': 4123, 'parent_poll': 2871, 'validation': 4068, 'rewards': 3857, 'completed': 4236, 'questions': 4359},
        'Sorting Primary Colors': {'started': 4773, 'introduction': 4733, 'mid_introduction': 3717, 'parent_poll': 2901, 'validation': 3662, 'rewards': 3559, 'completed': 3981, 'questions': 3967},
        'Quantitative Comparison': {'started': 7001, 'introduction': 6933, 'mid_introduction': 5682, 'parent_poll': 3822, 'validation': 5603, 'rewards': 5398, 'completed': 5829, 'questions': 5977},
        'Relational Comparison II': {'started': 6407, 'introduction': 6231, 'mid_introduction': 5183, 'parent_poll': 4076, 'validation': 5066, 'rewards': 4858, 'completed': 5197, 'questions': 5382},
        'Sorting Primary Shapes': {'started': 3761, 'introduction': 3652, 'mid_introduction': 2135, 'parent_poll': 3034, 'validation': 2086, 'rewards': 2050, 'completed': 2539, 'questions': 2351},
        'Numbers Comparison': {'started': 6151, 'introduction': 6069, 'mid_introduction': 4862, 'parent_poll': 3821, 'validation': 4739, 'rewards': 4464, 'completed': 4900, 'questions': 5172},
        'Color Blue': {'started': 5975, 'introduction': 5951, 'mid_introduction': 4967, 'parent_poll': 3459, 'validation': 4900, 'rewards': 4783, 'completed': 5221, 'questions': 5320},
        'Rhyming Words': {'started': 7585, 'introduction': 7467, 'mid_introduction': 5479, 'parent_poll': 3806, 'validation': 5370, 'rewards': 5028, 'completed': 5784, 'questions': 6075},
        'Shape Square': {'started': 3538, 'introduction': 3467, 'mid_introduction': 2692, 'parent_poll': 2002, 'validation': 2658, 'rewards': 2630, 'completed': 3063, 'questions': 3001},
        'Revision Colors': {'started': 4442, 'introduction': 4380, 'mid_introduction': 3570, 'parent_poll': 2311, 'validation': 3511, 'rewards': 3322, 'completed': 3703, 'questions': 3772},
        'Revision Shapes': {'started': 3527, 'introduction': 3467, 'mid_introduction': 2763, 'parent_poll': 1840, 'validation': 2709, 'rewards': 2628, 'completed': 2937, 'questions': 2968},
        'Beginning Sounds Ma/Ka/La': {'started': 9454, 'introduction': 8880, 'mid_introduction': 6488, 'parent_poll': 4590, 'validation': 6363, 'rewards': 6196, 'completed': 6789, 'questions': 6882},
        'Primary Emotion Labelling': {'started': 4322, 'introduction': 4277, 'mid_introduction': 3462, 'parent_poll': 2243, 'validation': 3389, 'rewards': 3289, 'completed': 3518, 'questions': 3637},
        'Identification of all emotions': {'started': 5456, 'introduction': 5361, 'mid_introduction': 4255, 'parent_poll': 3410, 'validation': 4154, 'rewards': 4027, 'completed': 4431, 'questions': 4473},
        'Beginning Sounds Pa/Cha/Sa': {'started': 7289, 'introduction': 7009, 'mid_introduction': 5132, 'parent_poll': 3516, 'validation': 5027, 'rewards': 4786, 'completed': 5444, 'questions': 5532},
        'Shape Rectangle': {'started': 3279, 'introduction': 3262, 'mid_introduction': 2570, 'parent_poll': 1789, 'validation': 2535, 'rewards': 2476, 'completed': 2778, 'questions': 2770},
        'Numerals 1-10': {'started': 3191, 'introduction': 3096, 'mid_introduction': 2508, 'parent_poll': 1836, 'validation': 2464, 'rewards': 2409, 'completed': 2590, 'questions': 2674},
        'Emotion Identification': {'started': 5641, 'introduction': 5463, 'mid_introduction': 4335, 'parent_poll': 3534, 'validation': 4223, 'rewards': 3919, 'completed': 4438, 'questions': 4642},
        'Beginning Sound Ba/Ra/Na': {'started': 4731, 'introduction': 4594, 'mid_introduction': 3483, 'parent_poll': 4355, 'validation': 3435, 'rewards': 3146, 'completed': 3570, 'questions': 3784},
        'Positions': {'started': 6273, 'introduction': 5940, 'mid_introduction': 4725, 'parent_poll': 6040, 'validation': 4614, 'rewards': 4473, 'completed': 4910, 'questions': 5027},
        'Beginning Sounds Ta/Va/Ga': {'started': 1339, 'introduction': 1281, 'mid_introduction': 965, 'parent_poll': 1312, 'validation': 937, 'rewards': 917, 'completed': 1060, 'questions': 1076},
        'Beginning Sounds Ka/Na/Ta': {'started': 4605, 'introduction': 4391, 'mid_introduction': 3061, 'parent_poll': 4517, 'validation': 2927, 'rewards': 2895, 'completed': 2923, 'questions': 3225},
        'Beginning Sounds Ma/Cha/Ba': {'started': 5388, 'introduction': 5126, 'mid_introduction': 4028, 'parent_poll': 5271, 'validation': 3874, 'rewards': 3838, 'completed': 3997, 'questions': 4203},
        'Beginning Sounds Sa/La/Va': {'started': 4966, 'introduction': 4823, 'mid_introduction': 3648, 'parent_poll': 4933, 'validation': 3525, 'rewards': 3503, 'completed': 3643, 'questions': 4274}
    }
    ...
    # Hide mapped users % when any global filters are applied
    if funnel_type == 'Users' and not has_date_filter and not has_global_filters:
        ...
        # Set percentage to 0 when date filter is applied, global filters are used, or not Users view
...
def main() -> None:
    ...
    conversion_games_df = game_conversion_df
    poll_games_df = poll_responses_df
    if selected_domains and len(selected_domains) > 0:
        if 'domain' in conversion_games_df.columns:
            conversion_games_df = conversion_games_df[conversion_games_df['domain'].isin(selected_domains)]
        if not poll_games_df.empty and 'domain' in poll_games_df.columns:
            poll_games_df = poll_games_df[poll_games_df['domain'].isin(selected_domains)]
    unique_games_from_conversion = set()
    if 'game_name' in conversion_games_df.columns:
        unique_games_from_conversion = set(conversion_games_df['game_name'].dropna().unique())
    unique_games_from_poll = set()
    if not poll_games_df.empty and 'game_name' in poll_games_df.columns:
        unique_games_from_poll = set(poll_games_df['game_name'].dropna().unique())
    ...
    if unique_domains or unique_languages or unique_games:
        filter_info = []
        if unique_domains:
    ...
    has_global_filters = has_game_filter or has_domain_filter or has_language_filter
