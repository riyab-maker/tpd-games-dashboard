...
def load_processed_data():
    ...
    try:
        ...
        # Load conversion funnel raw data - TPD Games Dashboard uses tpd_conversion_funnel.csv
        # Priority: 1) Root tpd_conversion_funnel.csv (raw with language), 2) data/tpd_conversion_funnel.csv, 3) fallback to processed_data
        ...
        root_path = "tpd_conversion_funnel.csv"
        data_path = os.path.join(DATA_DIR, "tpd_conversion_funnel.csv")
        ...
        if conversion_funnel_df is not None:
            ...
            # Fallback to processed_data_df if tpd_conversion_funnel.csv doesn't exist
...
st.set_page_config(page_title="TPD Games Dashboard", layout="wide")

def main() -> None:
    st.title("TPD Games Dashboard")
