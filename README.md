...
```
├── preprocess_data.py          # Data preprocessing script (run locally)
├── src/
│   └── streamlit_dashboard.py  # Lightweight visualization dashboard
├── data/                       # Processed data files (generated by preprocessing)
│   ├── processed_data.csv
│   ├── summary_data.csv
...
│   └── metadata.json
├── .github/workflows/
│   └── daily-preprocessing.yml # Automated daily data updates
└── README.md
```
